...
{{/*
Resource basename aligned with dev-profile-base compose container_name
(nvidia-cosmos3-reasoner) so NIMService / operator pod names match
Metropolis developer profile naming. Override via nameOverride /
fullnameOverride when needed.
*/}}
{{- define "cosmos3.name" -}}
